    ...
    return function (config, sidebar, router) {
      ...
      forceLink = d3Force.forceLink()
        .distance(function (d) {
          ...
          var meshlinks = d.o.source.node.meshlinks + d.o.target.node.meshlinks || 0;
          return Math.min(110, (Math.max(60, 40 + meshlinks * 10)));
        })
        .strength(function (d) {
          if (d.o.vpn) {
            return 0.00;
      ...
      var forceCharge = d3Force.forceManyBody()
        .strength(function () {
          return -50;
        });
