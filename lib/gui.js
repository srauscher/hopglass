define([ "chroma-js", "map", "sidebar", "tabs", "container", "meshstats",
         ...
         "filters/filtergui", "filters/hostname", "siteselector" ],
function (chroma, Map, Sidebar, Tabs, Container, Meshstats, Legend, Linklist,
          Nodelist, SimpleNodelist, Infobox, Proportions, ForceGraph,
          Title, About, DataDistributor, FilterGUI, HostnameFilter, SiteSelector) {
  return function (config, router) {
    ...
    var siteselector = new SiteSelector(config)
    ...
    fanoutUnfiltered.add(siteselector)
    fanout.add(nodelist)
    fanout.add(linklist)
