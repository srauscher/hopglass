define(function () {
    return function (config, el, router, d) {
        ...
        var linkCenterMap = document.createElement("a")
        linkCenterMap.textContent = "hier klicken"
        linkCenterMap.onclick = function () {
            centerMap()
            return false
        }
        linkCenterMap.href = "#"
        ...
        var hintCenterMap = document.createElement("p")
        hintCenterMap.appendChild(document.createTextNode("Oder "))
        hintCenterMap.appendChild(linkCenterMap)
        hintCenterMap.appendChild(document.createTextNode(" um die Koordinaten für das Zentrieren der Karte zu benutzen."))
        el.appendChild(hintCenterMap)
        ...
        function centerMap() {
            ...
            localStorage.setItem(pathname + "Latitude", lat)
            localStorage.setItem(pathname + "Longitude", lng)
        }
