    ...
    return function (config) {
      function handleData(data) {
        ...
        links.forEach(function (d) {
          ...
          if (d.vpn) {
            d.type = 'tunnel';
          } else if (d.type === undefined || d.type === 'wireless' || d.type === 'other') {
            d.vpn = false;
          } else {
            d.vpn = true;
          }
          ...
          if (d.vpn) {
            ...
            d.source.node.flags.uplink = true;
          } else {
